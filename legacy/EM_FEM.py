...
impacts = fromXls_Impact("./Hyundai_TPA/meta/EM_fem.xlsx", 'Impacts')
refChannels = to_channel(impacts)

virtual_channels = fromXls_VPChannels("./Hyundai_TPA/meta/EM_fem.xlsx", 'VP RefChannels')
#
##%% FRF Synthesis
...
qA = fromXls_VPChannels("./Hyundai_TPA/meta/EM_fem.xlsx","VP Channels")
...
mA = fromXls_VPChannels("./Hyundai_TPA/meta/EM_fem.xlsx","VP RefChannels")

IDMf_A = create_IDM_matrix(Y_FEM.RefChannels, mA)

consistency(Y_FEM, IDMf_A, dofs_i, dofs_j, arange(1,2000), Dim = 'Hammer', Type = 'Overall')

Yqm_FEM = create_reduced_FRF_matrix(Y_FEM, IDMf_A, IDMu_A)

plot(Yqm_FEM, 0, 2, PlotType = 'log')
plot(Yqm_FEM, 0, 2, PlotType = 'phase')
