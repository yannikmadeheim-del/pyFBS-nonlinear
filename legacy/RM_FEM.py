...
full_file = './Hyundai_TPA/Datasets/ansys/RM/RM.full'
result_file = './Hyundai_TPA/Datasets/ansys/RM/RM.rst'
...
sensors = fromXls_Sensor("./Hyundai_TPA/meta/RM_fem.xlsx", 'Sensors', "Channels")
channels = to_channel(sensors)

impacts = fromXls_Impact("./Hyundai_TPA/meta/RM_fem.xlsx", 'Impacts')
refChannels = to_channel(impacts)

virtual_channels = fromXls_VPChannels("./Hyundai_TPA/meta/RM_fem.xlsx", 'VP RefChannels')
#
##%% FRF Synthesis
...
qA = fromXls_VPChannels("./Hyundai_TPA/meta/RM_fem.xlsx","VP Channels")
...
consistency(Y_FEM, IDMu_A, dofs_i, dofs_j, arange(1,2000), Dim = 'Sensor', Type = 'Specific')

mA = fromXls_VPChannels("./Hyundai_TPA/meta/RM_fem.xlsx","VP RefChannels")

IDMf_A = create_IDM_matrix(Y_FEM.RefChannels, mA)

consistency(Y_FEM, IDMf_A, dofs_i, dofs_j, arange(1,2000), Dim = 'Hammer', Type = 'Specific')
